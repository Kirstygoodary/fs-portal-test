...
async function main() {
	...
	const FxERC20Child = await hre.ethers.getContractFactory("FxERC20Child");
  const fxErc20Child = await FxERC20Child.deploy();
  console.log("FxERC20 deployed to:", await fxErc20Child.getAddress());
